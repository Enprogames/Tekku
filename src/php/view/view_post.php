                ...
                <div class="post-content">
                    ...
                    <?php
                      ...
                      echo "<p>" . preg_replace_callback_array( //replaces instances of @pID or @tID/pID with their href counterparts for clickable referencing
                         [
                           $patterns[0] => function ($matches) use ($post, $db_interface) {
                              return "<a href='view_post.php?t={$post->topicID}&p={$db_interface->refPostMainPost($matches[1])}#$matches[1]'>@$matches[1]</a>";
                           },
